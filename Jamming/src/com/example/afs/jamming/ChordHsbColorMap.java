...
public class ChordHsbColorMap extends HsbColorMap {

  // "C", "C#", "D", "D#", "E", "F", "F#", "G", "G#", "A", "A#", "B", "C", "C#", "D", "D#", "E", "F", "F#", "G", "G#", "A", "A#", "B"
  // 0           2          4    5          7          9          11   12         14         16   17         19         21         23
  public ChordHsbColorMap() {
    add(HsbColorPalette.RED, new ScaleBasedChord("C", 60, 0, 2, 4));
    add(HsbColorPalette.ORANGE, new ScaleBasedChord("Dmin", 60, 2, 9));
    add(HsbColorPalette.YELLOW, new ScaleBasedChord("Emin", 60, 4, 7, 9));
